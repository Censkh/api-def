...
URL: https://censkh.github.io/api-def/middleware
...
Your middleware can respond instead of going to the network, as used by the built-in [client cache middleware](/api-def/caching/) .
