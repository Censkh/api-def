...
export type HeadersAddClientAddress = NonNullable<operations["addClientAddress"]["parameters"]["header"]>;
export type HeadersAddContractAddress = NonNullable<operations["addContractAddress"]["parameters"]["header"]>;
export type HeadersChargeFee = NonNullable<operations["chargeFee"]["parameters"]["header"]>;
export type HeadersCreateAccountContract = NonNullable<operations["createAccountContract"]["parameters"]["header"]>;
export type HeadersCreateCardContract = NonNullable<operations["createCardContract"]["parameters"]["header"]>;
export type HeadersCreateClient = NonNullable<operations["createClient"]["parameters"]["header"]>;
export type HeadersCreditContract = NonNullable<operations["creditContract"]["parameters"]["header"]>;
export type HeadersDebitContract = NonNullable<operations["debitContract"]["parameters"]["header"]>;
export type HeadersGetAccountContractId = NonNullable<operations["getAccountContractId"]["parameters"]["header"]>;
export type HeadersGetCardContract = NonNullable<operations["getCardContract"]["parameters"]["header"]>;
export type HeadersGetCardContractId = NonNullable<operations["getCardContractId"]["parameters"]["header"]>;
export type HeadersGetClientId = NonNullable<operations["getClientId"]["parameters"]["header"]>;
export type HeadersGetCvc = NonNullable<operations["getCvc"]["parameters"]["header"]>;
export type HeadersGetPin = NonNullable<operations["getPin"]["parameters"]["header"]>;
export type HeadersOpenEvent = NonNullable<operations["openEvent"]["parameters"]["header"]>;
export type HeadersReissueCard = NonNullable<operations["reissueCard"]["parameters"]["header"]>;
export type HeadersReverseTransaction = NonNullable<operations["reverseTransaction"]["parameters"]["header"]>;
export type HeadersSetClientCustomData = NonNullable<operations["setClientCustomData"]["parameters"]["header"]>;
export type HeadersSetContractCustomData = NonNullable<operations["setContractCustomData"]["parameters"]["header"]>;
export type HeadersSetPin = NonNullable<operations["setPin"]["parameters"]["header"]>;
export type HeadersSetServiceLimitTariff = NonNullable<operations["setServiceLimitTariff"]["parameters"]["header"]>;
export type HeadersUpdateAccountContract = NonNullable<operations["updateAccountContract"]["parameters"]["header"]>;
export type HeadersUpdateCardContract = NonNullable<operations["updateCardContract"]["parameters"]["header"]>;
export type HeadersUpdateClient = NonNullable<operations["updateClient"]["parameters"]["header"]>;
export type HeadersVerifyCardDetails = NonNullable<operations["verifyCardDetails"]["parameters"]["header"]>;
export type HeadersVerifyCvc = NonNullable<operations["verifyCvc"]["parameters"]["header"]>;
export type HeadersVerifyPin = NonNullable<operations["verifyPin"]["parameters"]["header"]>;
