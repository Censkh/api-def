...
slug: /
id: usage
title: Typed API definitions for TypeScript
sidebar_label: Usage
hide_title: true
description: Typed API definitions with middleware support. Install api-def and define typed queries, bodies, responses and URL parameters.
---
